...
To see the **web client**, click here: [GoBarber Web](https://github.com/kaioosilva/gobarber-web)
...
- Have this application's [API](https://github.com/kaioosilva/iniciando-back-end) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/kaioosilva/AppGoBarber.git && cd appgobarber
```
...
$ gh repo fork kaioosilva/AppGoBarber
```
